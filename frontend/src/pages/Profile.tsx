        ...
        <div className="flex flex-col max-w-5xl max-md:items-center">
          <div className="flex flex-row gap-16 max-md:flex-col max-md:items-center">
            <div className="flex flex-col items-center justify-start">
              <div className="w-28 h-28 rounded-full border border-black flex items-center justify-center">
                {profile == null ? (
                  <div className="relative h-full w-full overflow-hidden bg-yellow-400 rounded-full flex items-center justify-center text-5xl">
